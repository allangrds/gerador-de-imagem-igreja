...
loadFont('https://fonts.googleapis.com/css2?family=Dancing+Script:wght@700&family=Lato:wght@100;300;400;700&family=Merriweather:wght@400&family=Roboto&family=Open+Sans:wght@300;700&display=swap')
...
function setElementValues (content) {
  ...
  document.getElementsByClassName('es-jovem-title-2')[0].innerHTML = content['preacher-message-title-2']
...
function saveThumbnailYoutubeImage () {
  const div = document.getElementsByClassName('thumb-youtube-es-adultos')[0]
